...
export const metadata: Metadata = {
  title: "Light to Life International Ministries",
...
export default function RootLayout({
  ...
  return (
    <html lang="en" className={`${geistSans.variable} ${geistMono.variable} ${cormorantGaramond.variable} ${inter.variable}`} data-theme="light">
      <body>
        {children}
        <FooterWrapper />
      </body>
